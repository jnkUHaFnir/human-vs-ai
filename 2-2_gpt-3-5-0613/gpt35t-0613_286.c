                ...
                if (text[i] == 'f' && text[i + 1] == 'r' && text[i + 2] == 'o' && text[i + 3] == 'm') {
                    ...
                    while (1) {
                        if (text[i] == ':') {
                            ...
                            strncpy(serv_data[menunum].charge_arr[menunum_charge].percentage, name, sizeof(serv_data[menunum].charge_arr[menunum_charge].percentage));
                            memset(name, 0, sizeof(name));
                            i++;
                            break;
                        } else {
