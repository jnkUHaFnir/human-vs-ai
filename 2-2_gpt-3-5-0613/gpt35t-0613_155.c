...
int main(void) {
    ...
    for (i = 3; i < 6; i++) {
        ...
        student_t[i].name = malloc(100 * sizeof(char));
        student_t[i].surname = malloc(100 * sizeof(char));
        student_t[i].UUN = malloc(100 * sizeof(char));
        student_t[i].department = malloc(100 * sizeof(char));
