...
int main(void) {
    ...
    for (i = 3; i < 6; i++) {
        student[i].name = malloc(100); // Allocate memory for name
        student[i].surname = malloc(100); // Allocate memory for surname
        student[i].UUN = malloc(100); // Allocate memory for UUN
