    ...
    #endif
            // NOTE/BUG: this is why you can't do multiple clients at the same
            // time -- you are doing a thread join
            // but you _had_ to because the main thread doesn't know when a thread
            // is done with the control struct
            // the pthread_create should
    #if 0
