           ...
           text[i+2] == 'd') {
            while (1) { //while "id
                ...
                if(text[i] == ':') {
                  ...
                  text[i+5] == 'c'&& text[i+6] == 'e'&& text[i+7] == '_'){
            if(text[i+8] == 'c' && text[i+9] == 'h' && text[i+10] == 'a' && text[i+11] == 'r' && text[i+12] == 'g' &&
               text[i+13] == 'e' && text[i+14] == '_' && text[i+15] == 'l' && text[i+16] == 'i' && text[i+17] == 's' &&
               text[i+18] == 't') {              
                menunum_charge = 0;
                while (1)//while charge_list
                {
                    if(i>=len) {
                        break;
                    }
