ifstream file("example.zip", ios::binary | ios::ate);
if (file.is_open())
{
    ...
    string base64Data = base64_encode(reinterpret_cast<const unsigned char*>(fileData.data()), fileData.size());
    
    // Include the Base64 encoded data in the post body
