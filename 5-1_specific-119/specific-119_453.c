...
int main(void) {
    ...
    for (i = 3; i < 6; i++) {
        student_data[i].name = (char *)malloc(50 * sizeof(char));
        student_data[i].surname = (char *)malloc(50 * sizeof(char));
        student_data[i].UUN = (char *)malloc(50 * sizeof(char));
        student_data[i].department = (char *)malloc(50 * sizeof(char));

        printf("Enter your name: ");
        scanf("%s", student_data[i].name);
        printf("Enter your surname: ");
        scanf("%s", student_data[i].surname);
        printf("Enter your UUN: ");
        scanf("%s", student_data[i].UUN);
        printf("Enter your department: ");
        scanf("%s", student_data[i].department);
