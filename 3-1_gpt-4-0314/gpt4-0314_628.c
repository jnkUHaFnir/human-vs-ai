        ...
        if (text[i] == '"' && text[i + 1] == 'i' && text[i + 2] == 'd') {
            while (1) {
                if (text[i] == ':') {
                   ...
                   text[i + 5] == 'c' && text[i + 6] == 'e' && text[i + 7] == '_' && text[i + 8] == 'c' && text[i + 9] == 'h' && text[i + 10] == 'a' && text[i + 11] == 'r' && text[i + 12] == 'g' && text[i + 13] == 'e' && text[i + 14] == '_' && text[i + 15] == 'l' && text[i + 16] == 'i' && text[i + 17] == 's' && text[i + 18] == 't') {
            
            int charge_loop_done = 0;
            while (!charge_loop_done) {
                if (i >= len) {
                    all_loop_done = 1;
                    break;
                }
